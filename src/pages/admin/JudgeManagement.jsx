...
const JudgeManagement = () => {
    ...
    const tabs = [
        ...
        { id: 'conflicts', label: 'Conflicts', icon: AlertCircle, count: conflicts.filter(c => c.status === 'Pending').length },
                ...
                <div className="space-y-4">
                    {conflicts.length === 0 ? (
                        ...
                        conflicts.map(conflict => {
                            ...
                            return (
                                <div key={conflict.id} className={`p-6 rounded-2xl border transition-all ${
                                    conflict.status === 'Resolved' 
                                        ? 'bg-slate-50/50 dark:bg-slate-900/30 border-slate-200 dark:border-slate-800 opacity-60' 
                                        : 'bg-white dark:bg-slate-900 border-amber-200 dark:border-amber-900/50 shadow-lg shadow-amber-500/5'
                                }`}>
                                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                                        <div className="space-y-4 flex-1">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <span className="text-[10px] text-slate-400">
                                                    Flagged on {new Date(conflict.flaggedAt).toLocaleDateString()}
                                                </span>
                                            </div>
                                        ...
                                        {conflict.status === 'Pending' && (
                                            <div className="flex flex-col gap-2">
                                                ...
                                                <button
                                                    onClick={() => {
                                                        // Future: Open a reassignment-specific modal
                                                        // For now, let's just use the existing unassign/assign flow
