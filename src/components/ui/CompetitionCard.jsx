...
import { Calendar, Users, Trophy, Heart, MessageCircle, Share2, Bookmark, ChevronRight, Eye } from 'lucide-react';
            ...
            <div className="flex flex-col gap-3">
              <div className="flex gap-3">
                <Link
                  ...
                  className="flex-1 py-2.5 rounded-xl font-bold bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-200 hover:bg-slate-200 dark:hover:bg-slate-700 transition-all duration-300 flex items-center justify-center gap-2 text-sm"
                >
                  <Eye size={16} />
                  View Timeline
                </Link>
              ...
              <button
                ...
                className="w-full py-3 rounded-xl font-bold bg-slate-900 dark:bg-white text-white dark:text-slate-900 shadow-lg shadow-slate-900/20 hover:shadow-xl hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 flex items-center justify-center gap-2 text-sm"
              >
                Register Now
