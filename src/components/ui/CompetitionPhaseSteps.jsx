  ...
  return (
    <div className="w-full py-6 px-4">
      <div className="relative flex items-center justify-between">
        ...
        <div 
          className="absolute left-0 top-1/2 -translate-y-1/2 h-0.5 bg-violet-500 transition-all duration-500 -z-10" 
        ...
        {phases.map((phase, idx) => {
          ...
          return (
            <div key={phase} className="flex flex-col items-center gap-2 group">
              <div className={cn(
              ...
              <span className={cn(
                "text-[10px] sm:text-xs font-bold whitespace-nowrap transition-colors duration-300",
